...
// These tests stop at the authorization redirect, so use introspection without requiring signing keys.
@AddConfig(key = "security.providers.1.oidc.validate-jwt-with-jwk", value = "false")
